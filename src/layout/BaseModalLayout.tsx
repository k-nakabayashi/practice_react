...
export const BaseModalLayout = ( {children, hideModal, style=modal_base_style, inner_style=modal_base_inner_style}: BaseModalLayoutProps) => {

    return (
      <div 
        style={style}
      >
        <div className="container" style={inner_style}>
